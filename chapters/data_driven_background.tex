...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/jet_pt_1_sum_1}\\
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/jet_pt_2_sum_1}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/lep_pt_1_sum_1}\\
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/lep_pt_2_sum_1}
    \caption{Expected and observed distributions of the \pt of the leading
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/had_mass_optional_btag_sum_1}\\
    \includegraphics[width=.8\textwidth]{images/pdf/same-sign,_2_jets/lep_mass_sum_1}
