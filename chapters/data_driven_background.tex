...
The fake rate was calculated 
in QCD samples (\texttt{QCD\_Pt-15to3000} for electrons and
\texttt{QCD\_Pt-20\_MuEnrichedPt-15} for muons), without the cuts on the
\met and $\mt$,  as there are no vector bosons in the QCD MC:
\begin{align*}
    f_{\E} &= 0.091 \pm 0.017\\
    f_{\M} &= 0.152 \pm 0.002
\end{align*}
