...
\section{Event reconstruction improvement and b-tagging}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.7\textwidth]{images/pdf/4jets_AND_mr200_AND_had_mass350/r_optional_btag_0}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.7\textwidth]{images/pdf/4jets_AND_r02_AND_had_mass350/mr_optional_btag_0}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.7\textwidth]{images/pdf/4jets_AND_mr200_AND_r02/had_mass_optional_btag_0}
