...
\begingroup
\setbeamertemplate{footline}{\large{\vspace*{-2cm}\centering Many thanks to the
...
\begin{frame}
    ...
    \uncover<2->{
        ...
        \begin{figure}[h]
            \centering
            \subfigure[Standard razor example from SUSY]{
                \includegraphics[width=.4\textwidth]{standard_razor_susy.eps}}
                \subfigure[Top Partner
                event]{\includegraphics[width=.4\textwidth]{toppartner_decay_top_color.eps}}
        \end{figure}
    }
\end{frame}
