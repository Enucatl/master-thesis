    ...
    \begin{block}
        ...
        \begin{figure}[h!]
            \centering
                ...
                \vcenter{\hbox{\includegraphics[height=.2\textheight]{kepler}}}$
...
\begin{frame}
    ...
    \centering
                ...
                we expected!}
                $\vcenter{\hbox{\includegraphics[height=.2\textheight]{maxwell}}}$
...
\begin{frame}
    ...
    \begin{figure}[h!]
        \centering
        \only<3>{\includegraphics[width=.35\textwidth]{standard_model_particles_1family}}
        \only<4>{\includegraphics[width=.35\textwidth]{standard_model_particles}}
    \end{figure}
\end{frame}
